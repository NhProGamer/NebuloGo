...
const bytes = 123456789; // Remplacez par la valeur en octets que vous souhaitez convertir
console.log(formatBytes(bytes)); // Affiche "117.74 Mo"
        ...
        if (item.Type === 'file') {
            return `
             <tr class="hover:bg-gray-100 context-menu-target" data-info="${item.Name}" data-type="file">
                ...
                <td class="px-4 py-2">${day}/${month}/${year} ${hours}h${minutes}</td>
            </tr>`
